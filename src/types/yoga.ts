...
declare global {
  ...
  namespace Yoga {
    ...
    type YogaDirection = typeof DIRECTION_INHERIT | typeof DIRECTION_LTR | typeof DIRECTION_RTL

    type YogaFlexWrap = typeof WRAP_NO_WRAP | typeof WRAP_WRAP | typeof WRAP_WRAP_REVERSE
    ...
    type YogaUnit = typeof UNIT_AUTO | typeof UNIT_PERCENT | typeof UNIT_POINT | typeof UNIT_UNDEFINED

    type YogaOverflow = typeof OVERFLOW_HIDDEN | typeof OVERFLOW_SCROLL | typeof OVERFLOW_VISIBLE

    type YogaPositionType = typeof POSITION_TYPE_ABSOLUTE | typeof POSITION_TYPE_RELATIVE
